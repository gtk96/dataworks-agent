...
import { DataWorksScopeBar } from "@/components/dataworks/scope-bar"
...
export function SessionHeader() {
  ...
  return (
    <>
      <Show when={isV2()}>
        <div
          data-component="session-dataworks-scope"
          class="w-full shrink-0 border-b border-[color:var(--dwa-border)] bg-v2-background-bg-base px-3 py-2"
        >
          <DataWorksScopeBar />
        </div>
      </Show>
