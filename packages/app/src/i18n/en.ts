...
export const dict = {
  ...
  "dataworks.shell.nav": "DataWorks navigation",
  "dataworks.nav.connections": "Connections",
  "dataworks.nav.explorer": "Explorer",
  "dataworks.nav.jobs": "Jobs",
  "dataworks.nav.skills": "Skills",
  "dataworks.nav.knowledge": "Knowledge",
  "dataworks.nav.audit": "Audit",
  "dataworks.state.loading": "Loading…",
  "dataworks.state.empty": "Nothing here yet.",
  "dataworks.state.partial": "Partial results — some data may be missing.",
  "dataworks.state.rateLimit": "Rate limited. Please wait and retry.",
  "dataworks.state.error": "Something went wrong.",
  "dataworks.state.retry": "Retry",
  "dataworks.auth.redirecting": "Redirecting to login…",
  "dataworks.auth.logout": "Log out",
  "dataworks.auth.login.title": "Sign in",
  "dataworks.auth.login.subtitle": "Sign in with your local admin username (default: admin).",
  "dataworks.auth.email": "Username",
  "dataworks.auth.username": "Username",
  "dataworks.auth.password": "Password",
  "dataworks.auth.login.submit": "Sign in",
  "dataworks.auth.failed": "Invalid username or password.",
  "dataworks.auth.rateLimited": "Too many attempts. Try again later.",
  "dataworks.connection.selector.label": "Connection",
  "dataworks.connection.selector.empty": "No connections",
  "dataworks.connection.create": "Add connection",
  "dataworks.connection.name": "Name",
  "dataworks.connection.region": "Region",
  "dataworks.connection.ak": "Access key ID",
  "dataworks.connection.sk": "Access key secret",
  "dataworks.connection.write.toggle": "Enable write operations",
  "dataworks.connection.write.on": "Write enabled",
  "dataworks.connection.write.off": "Read only",
  "dataworks.connection.save": "Save connection",
  "dataworks.connection.created": "Connection saved (secret stored server-side).",
  "dataworks.connection.test": "Test",
  "dataworks.connection.test.ok": "Connection OK — {{count}} project(s).",
  "dataworks.connection.delete": "Delete",
  "dataworks.explorer.projects.load": "Load projects",
  "dataworks.explorer.project": "Project",
  "dataworks.explorer.tables.search": "Search tables",
  "dataworks.explorer.tables.submit": "Search",
  "dataworks.explorer.schema": "Schema",
  "dataworks.explorer.partition": "Partition",
  "dataworks.explorer.sql.title": "SQL (bounded)",
  "dataworks.explorer.sql.run": "Run",
  "dataworks.explorer.sql.tooLong": "SQL exceeds {{max}} characters.",
  "dataworks.jobs.projectId": "Project ID",
  "dataworks.jobs.statusFilter": "Status filter",
  "dataworks.jobs.refresh": "Refresh",
  "dataworks.jobs.status": "Status",
  "dataworks.jobs.rerun": "Rerun",
  "dataworks.jobs.supplement": "Supplement",
  "dataworks.jobs.pause": "Pause",
  "dataworks.jobs.listHint": "This list shows DataWorks instances (ListInstances). Rerun needs an instance id; supplement and pause use the related node id. Node ids are never sent to restartInstance.",
  "dataworks.jobs.row.instance": "instance {{id}}",
  "dataworks.jobs.row.noInstance": "no instance id",
  "dataworks.jobs.row.node": "node {{id}}",
  "dataworks.jobs.row.noNode": "no node id",
  "dataworks.jobs.action.queued": "Queued {{action}} for {{id}} (requires write confirmation in session).",
  "dataworks.jobs.action.needProject": "Select a connection and enter a numeric project ID first.",
  "dataworks.jobs.action.writeDisabled": "Writes are disabled for this connection. Enable write on the connection first.",
  "dataworks.jobs.action.badTarget": "Could not resolve a node id for this action.",
  "dataworks.jobs.action.needInstanceId": "Rerun requires an instance id. This row has none (do not use node id for restartInstance).",
  "dataworks.jobs.action.success": "{{action}} for {{id}} completed ({{status}}).",
  "dataworks.knowledge.upload": "Upload document",
  "dataworks.knowledge.refresh": "Refresh",
  "dataworks.knowledge.empty": "No documents uploaded yet.",
  "dataworks.knowledge.status": "Status",
  "dataworks.skills.hint": "System skills are read-only. User skills live under your private skills directory.",
  "dataworks.skills.system": "System skills",
  "dataworks.skills.user": "Your skills",
  "dataworks.skills.create": "Create skill",
  "dataworks.skills.name": "Name",
  "dataworks.skills.markdown": "SKILL.md",
  "dataworks.skills.save": "Save skill",
  "dataworks.skills.saved": "Skill saved.",
  "dataworks.skills.delete": "Delete",
  "dataworks.skills.readonly": "Read-only (system)",
  "dataworks.skills.empty": "No skills yet.",
  "dataworks.skills.error": "Could not save skill.",
  "dataworks.audit.scope.me": "Showing your events only.",
  "dataworks.audit.scope.all": "Admin: filtering all users.",
  "dataworks.audit.filter.allUsers": "Filter all users",
  "dataworks.audit.filter.mine": "My events only",
  "dataworks.audit.filter.userId": "User ID",
  "dataworks.audit.refresh": "Refresh",
  "dataworks.audit.col.time": "Time",
  "dataworks.audit.col.tool": "Tool",
  "dataworks.audit.col.outcome": "Outcome",
  "dataworks.audit.col.reason": "Reason",
  "dataworks.audit.forbidden.title": "Not allowed",
  "dataworks.audit.forbidden.body": "Only administrators can open the all-users audit view.",
  "dataworks.audit.forbidden.back": "Back to my audit log",
  "dataworks.write.title": "Confirm DataWorks write",
  "dataworks.write.tool": "Tool",
  "dataworks.write.target": "Target",
  "dataworks.write.connection": "Connection",
  "dataworks.write.connection.unknown": "Unknown connection",
  "dataworks.write.reason.label": "Reason (required)",
  "dataworks.write.reason.placeholder": "Why is this write needed?",
  "dataworks.write.approve": "Approve once",
  "dataworks.write.reject": "Reject",

  "dataworks.scope.project": "Project",
  "dataworks.scope.project.empty": "No projects",
  "dataworks.scope.manage": "Manage connections",
  "dataworks.scope.current": "Active scope",
  "dataworks.dashboard.title": "Chat",
  "dataworks.dashboard.subtitle": "Choose connection / project, then ask or write SQL",
  "dataworks.dashboard.newChat": "New chat",
  "dataworks.dashboard.history": "Refresh context",
  "dataworks.dashboard.refresh": "Refresh",
  ...
  "dataworks.dashboard.startHint": "Does not auto-send; click send to open a chat",
  "dataworks.dashboard.send": "Send",
  ...
  "dataworks.dashboard.missingProject": "Select a project (or refresh to load).",
  "dataworks.dashboard.missingPrompt": "Enter a question or SQL.",
  "dataworks.dashboard.missingRuntime": "Chat runtime is not ready yet. Retry in a moment.",
  "dataworks.dashboard.needConnectionTitle": "No DataWorks connection yet",
  "dataworks.dashboard.needConnectionBody": "Add an AccessKey connection first to query tables and run SQL. LLM config is separate.",
  "dataworks.dashboard.needProjectTitle": "No project available",
  "dataworks.dashboard.projectEmpty": "No projects for this connection. Check AK permissions or region.",
  "dataworks.dashboard.projectLoadError": "Failed to load projects. Check credentials and retry.",
  "dataworks.dashboard.runtimeMissingTitle": "Cannot open chat",
  "dataworks.dashboard.runtimeMissingBody": "Local OpenCode server or workspace is not ready.",
  "dataworks.dashboard.sendFailedTitle": "Send failed",
  "dataworks.dashboard.sendFailedBody": "Could not create a chat draft.",
  "dataworks.dashboard.quick": "Quick actions",
  "dataworks.dashboard.quickHint": "Click to fill the input; never auto-sends",
  "dataworks.chat.hero": "Ask DataWorks in natural language",
  "dataworks.chat.hero.hint": "List tables, run bounded SQL, inspect jobs — results appear as chat cards.",
  "dataworks.chat.suggestion.projects": "List projects I can access",
  "dataworks.chat.suggestion.tables": "Search tables in the current project",
  "dataworks.chat.suggestion.jobs": "Show recent failed jobs",
  "dataworks.chat.suggestion.sql": "Run SELECT 1 as a health check",
  "dataworks.chat.send": "Send",
  "dataworks.chat.attach": "Attach files or context",
  "dataworks.chat.scope.none": "No connection / project selected",
  "dataworks.chat.model.default": "DataWorks AI",
  "dataworks.chat.hints.try": "Try asking",
  "dataworks.chat.footer.scope": "Grounded in your active project's connected data",
  "dataworks.chat.footer.shortcut": "send",
  "dataworks.chat.footer.privacy": "Answers are private; writes require confirmation",
  "dataworks.chat.footer.compliance": "Runs locally · Data stays on-prem",
  "dataworks.chat.placeholder.aria": "Ask a question or paste SQL",
  "dataworks.chat.prompt.tables": "Search tables in the current project",
  "dataworks.chat.prompt.jobs": "Show recent failed jobs",
  "dataworks.chat.prompt.orders": "Diagnose order cost / logistics anomalies",
  "dataworks.chat.prompt.ping": "SELECT 1",
  "dataworks.chat.label.tables": "Search tables",
  "dataworks.chat.label.jobs": "Failed jobs",
  "dataworks.chat.label.orders": "Order diagnostics",
  "dataworks.chat.label.ping": "Health check",
  "dataworks.chat.hint.tables": "List active tables in last 30 days",
  "dataworks.chat.hint.jobs": "Pinpoint root cause of recent failures",
  "dataworks.chat.hint.orders": "Surface order anomalies",
  "dataworks.chat.hint.ping": "Verify connectivity fast",
  "dataworks.chat.category.tables": "TABLES",
  "dataworks.chat.category.jobs": "JOBS",
  "dataworks.chat.category.orders": "DIAG",
  "dataworks.chat.category.ping": "SQL",
  "dataworks.chat.scope.change": "Switch connection or project",
  "dataworks.chat.model.change": "Switch model",
  "dataworks.chat.env.prod": "PROD",
  "dataworks.chat.env.staging": "STG",
  "dataworks.chat.env.dev": "DEV",
  "dataworks.chat.env.unknown": "—",
  "dataworks.chat.env.prod.full": "Production — writes require confirmation",
  "dataworks.chat.env.staging.full": "Staging",
