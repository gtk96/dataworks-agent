...
export const dict = {
  ...
  "session.header.reveal.containingFolder": "打开包含文件夹",
  ...
  "dataworks.shell.product": "DataWorks Agent",
  "dataworks.shell.console": "控制台",
  "dataworks.nav.chat": "对话",
  "dataworks.nav.mcp": "MCP",
  "dataworks.nav.settings": "设置",
  "dataworks.shell.nav": "DataWorks 导航",
  "dataworks.nav.connections": "数据连接",
  "dataworks.nav.explorer": "数据探索",
  "dataworks.nav.jobs": "任务中心",
  "dataworks.nav.skills": "技能",
  "dataworks.nav.knowledge": "知识库",
  "dataworks.nav.audit": "审计",
  "dataworks.state.loading": "加载中…",
  "dataworks.state.empty": "暂无数据。",
  "dataworks.state.partial": "部分结果 — 可能不完整。",
  "dataworks.state.rateLimit": "请求过于频繁，请稍后重试。",
  "dataworks.state.error": "出错了。",
  "dataworks.state.retry": "重试",
  "dataworks.auth.redirecting": "正在跳转到登录…",
  "dataworks.auth.logout": "退出登录",
  "dataworks.auth.login.title": "登录",
  "dataworks.auth.login.subtitle": "使用本地管理员账号登录（默认用户名 admin）。",
  "dataworks.auth.email": "用户名",
  "dataworks.auth.username": "用户名",
  "dataworks.auth.password": "密码",
  "dataworks.auth.login.submit": "登录",
  "dataworks.auth.failed": "用户名或密码错误。",
  "dataworks.auth.rateLimited": "尝试次数过多，请稍后再试。",
  "dataworks.connection.selector.label": "连接",
  "dataworks.connection.selector.empty": "暂无连接",
  "dataworks.connection.create": "添加连接",
  "dataworks.connection.name": "名称",
  "dataworks.connection.region": "地域",
  "dataworks.connection.ak": "AccessKey ID",
  "dataworks.connection.sk": "AccessKey Secret",
  "dataworks.connection.write.toggle": "启用写操作",
  "dataworks.connection.write.on": "写已启用",
  "dataworks.connection.write.off": "只读",
  "dataworks.connection.save": "保存连接",
  "dataworks.connection.created": "连接已保存（密钥仅保存在服务端）。",
  "dataworks.connection.test": "测试",
  "dataworks.connection.test.ok": "连接正常 — {{count}} 个项目。",
  "dataworks.connection.delete": "删除",
  "dataworks.explorer.projects.load": "加载项目",
  "dataworks.explorer.project": "项目",
  "dataworks.explorer.tables.search": "搜索表",
  "dataworks.explorer.tables.submit": "搜索",
  "dataworks.explorer.schema": "Schema",
  "dataworks.explorer.partition": "分区",
  "dataworks.explorer.sql.title": "SQL（有界）",
  "dataworks.explorer.sql.run": "运行",
  "dataworks.explorer.sql.tooLong": "SQL 超过 {{max}} 个字符。",
  "dataworks.jobs.projectId": "项目 ID",
  "dataworks.jobs.statusFilter": "状态筛选",
  "dataworks.jobs.refresh": "刷新",
  "dataworks.jobs.status": "状态",
  "dataworks.jobs.rerun": "重跑",
  "dataworks.jobs.supplement": "补数据",
  "dataworks.jobs.pause": "暂停",
  "dataworks.jobs.listHint": "列表来自 DataWorks 实例（ListInstances）。重跑需要 instance id；补数据与暂停使用关联的 node id。不会把 node id 当作 restartInstance 的入参。",
  "dataworks.jobs.row.instance": "实例 {{id}}",
  "dataworks.jobs.row.noInstance": "无实例 ID",
  "dataworks.jobs.row.node": "节点 {{id}}",
  "dataworks.jobs.row.noNode": "无节点 ID",
  "dataworks.jobs.action.queued": "已排队 {{action}}（{{id}}），需在会话中确认写操作。",
  "dataworks.jobs.action.needProject": "请先选择连接并填写数字项目 ID。",
  "dataworks.jobs.action.writeDisabled": "该连接未开启写权限，请先在连接中启用写入。",
  "dataworks.jobs.action.badTarget": "无法解析该操作所需的节点 ID。",
  "dataworks.jobs.action.needInstanceId": "重跑需要 instance id。当前行没有实例 ID（不可用 node id 调用 restartInstance）。",
  "dataworks.jobs.action.success": "{{action}}（{{id}}）已完成（{{status}}）。",
  "dataworks.knowledge.upload": "上传文档",
  "dataworks.knowledge.refresh": "刷新",
  "dataworks.knowledge.empty": "尚未上传文档。",
  "dataworks.knowledge.status": "状态",
  "dataworks.skills.hint": "系统技能只读。用户技能位于你的私有 skills 目录。",
  "dataworks.skills.system": "系统技能",
  "dataworks.skills.user": "我的技能",
  "dataworks.skills.create": "创建技能",
  "dataworks.skills.name": "名称",
  "dataworks.skills.markdown": "SKILL.md",
  "dataworks.skills.save": "保存技能",
  "dataworks.skills.saved": "技能已保存。",
  "dataworks.skills.delete": "删除",
  "dataworks.skills.readonly": "只读（系统）",
  "dataworks.skills.empty": "暂无技能。",
  "dataworks.skills.error": "无法保存技能。",
  "dataworks.audit.scope.me": "仅显示你的事件。",
  "dataworks.audit.scope.all": "管理员：筛选全部用户。",
  "dataworks.audit.filter.allUsers": "筛选全部用户",
  "dataworks.audit.filter.mine": "仅我的事件",
  "dataworks.audit.filter.userId": "用户 ID",
  "dataworks.audit.refresh": "刷新",
  "dataworks.audit.col.time": "时间",
  "dataworks.audit.col.tool": "工具",
  "dataworks.audit.col.outcome": "结果",
  "dataworks.audit.col.reason": "原因",
  "dataworks.audit.forbidden.title": "无权访问",
  "dataworks.audit.forbidden.body": "仅管理员可打开全部用户审计视图。",
  "dataworks.audit.forbidden.back": "返回我的审计日志",
  "dataworks.write.title": "确认 DataWorks 写操作",
  "dataworks.write.tool": "工具",
  "dataworks.write.target": "目标",
  "dataworks.write.connection": "连接",
  "dataworks.write.connection.unknown": "未知连接",
  "dataworks.write.reason.label": "原因（必填）",
  "dataworks.write.reason.placeholder": "为什么需要此写操作？",
  "dataworks.write.approve": "批准一次",
  "dataworks.write.reject": "拒绝",

  "dataworks.scope.project": "项目",
  "dataworks.scope.project.empty": "暂无项目",
  "dataworks.scope.manage": "管理连接",
  "dataworks.scope.current": "当前选择",
  "dataworks.dashboard.title": "对话",
  "dataworks.dashboard.subtitle": "选连接 / 项目后直接提问或写 SQL",
  "dataworks.dashboard.newChat": "新建对话",
  "dataworks.dashboard.history": "刷新上下文",
  "dataworks.dashboard.refresh": "刷新",
  ...
  "dataworks.dashboard.startHint": "未自动发送，点击发送后进入对话",
  "dataworks.dashboard.send": "发送",
  "dataworks.dashboard.placeholder": "输入自然语言或 SQL，例如：查找物流成本异常订单…",
  "dataworks.dashboard.missingConnection": "请先选择连接。",
  "dataworks.dashboard.missingProject": "请先选择项目（或刷新加载）。",
  "dataworks.dashboard.missingPrompt": "请输入问题或 SQL。",
  "dataworks.dashboard.missingRuntime": "对话运行时未就绪，请稍后重试。",
  "dataworks.dashboard.needConnectionTitle": "还没有 DataWorks 连接",
  "dataworks.dashboard.needConnectionBody": "请先添加 AccessKey 连接，才能查表和跑 SQL。LLM 配置与这里无关。",
  "dataworks.dashboard.needProjectTitle": "还没有可用项目",
  "dataworks.dashboard.projectEmpty": "该连接下暂无项目，请检查 AK 权限或换区域。",
  "dataworks.dashboard.projectLoadError": "项目列表加载失败，请检查连接凭据后重试。",
  "dataworks.dashboard.runtimeMissingTitle": "无法打开对话",
  "dataworks.dashboard.runtimeMissingBody": "本地 OpenCode 服务或工作区未就绪。",
  "dataworks.dashboard.sendFailedTitle": "发送失败",
  "dataworks.dashboard.sendFailedBody": "创建对话草稿时出错。",
  "dataworks.dashboard.quick": "常用操作",
  "dataworks.dashboard.quickHint": "点击填入输入框，不会自动发送",
  "dataworks.chat.hero": "用自然语言操作 DataWorks",
  "dataworks.chat.hero.hint": "查表、跑有界 SQL、看作业状态——结果会以对话卡片展示。",
  "dataworks.chat.suggestion.projects": "列出我能访问的项目",
  "dataworks.chat.suggestion.tables": "在当前项目中搜索表",
  "dataworks.chat.suggestion.jobs": "查看最近失败的作业",
  "dataworks.chat.suggestion.sql": "跑一条 SELECT 1 做连通性检查",
  "dataworks.chat.send": "发送",
  "dataworks.chat.attach": "附加文件或参考",
  "dataworks.chat.scope.none": "未选择连接 / 项目",
  "dataworks.chat.model.default": "DataWorks AI",
  "dataworks.chat.hints.try": "试试这样问",
  "dataworks.chat.footer.scope": "基于当前项目已连接的数据生成",
  "dataworks.chat.footer.shortcut": "发送",
  "dataworks.chat.footer.privacy": "回答仅本人可见，写操作需确认",
  "dataworks.chat.footer.compliance": "本地运行 · 数据不出域",
  "dataworks.chat.placeholder.aria": "输入问题或 SQL",
  "dataworks.chat.prompt.tables": "搜索当前项目的业务表",
  "dataworks.chat.prompt.jobs": "查看最近失败任务",
  "dataworks.chat.prompt.orders": "订单成本/物流异常诊断",
  "dataworks.chat.prompt.ping": "SELECT 1",
  "dataworks.chat.label.tables": "搜索业务表",
  "dataworks.chat.label.jobs": "失败任务",
  "dataworks.chat.label.orders": "订单诊断",
  "dataworks.chat.label.ping": "连通性检查",
  "dataworks.chat.hint.tables": "列出近 30 天活跃表",
  "dataworks.chat.hint.jobs": "定位最近失败根因",
  "dataworks.chat.hint.orders": "找出异常订单线索",
  "dataworks.chat.hint.ping": "快速验证连接可用",
  "dataworks.chat.category.tables": "表查询",
  "dataworks.chat.category.jobs": "任务",
  "dataworks.chat.category.orders": "诊断",
  "dataworks.chat.category.ping": "SQL",
  "dataworks.chat.scope.change": "切换连接或项目",
  "dataworks.chat.model.change": "切换模型",
  "dataworks.chat.env.prod": "PROD",
  "dataworks.chat.env.staging": "STG",
  "dataworks.chat.env.dev": "DEV",
  "dataworks.chat.env.unknown": "—",
  "dataworks.chat.env.prod.full": "生产环境，写操作需确认",
  "dataworks.chat.env.staging.full": "预发环境",
  "dataworks.chat.env.dev.full": "开发环境",
  "dataworks.chat.env.unknown.full": "环境未识别",
  "dataworks.chat.subtitle": "查表 · 跑作业 · 诊断异常订单 · 测连接",
  "dataworks.workbench.navigation": "主导航",
  "dataworks.workbench.menu": "菜单",
  "dataworks.workbench.resources": "资源",
  "dataworks.workbench.agent": "智能助手",
  "dataworks.workbench.noConnection": "未选择连接",
  "dataworks.workbench.noProject": "未选择项目",
  "dataworks.workbench.noRegion": "未选择地域",
  "dataworks.workbench.noProjectSelected": "尚未选择项目",
  "dataworks.workbench.resizeResources": "调整资源面板宽度",
  "dataworks.workbench.resizeAgent": "调整智能助手面板宽度",
  "dataworks.workbench.noPlan": "当前会话没有执行计划。",
  "dataworks.workbench.overwriteConfirm": "要用智能助手生成的查询替换当前 SQL 吗？未保存的编辑将被丢弃。",
  "dataworks.workbench.resultPreview": "结果预览 · {{rows}} 行 · {{columns}} 列",
  "dataworks.workbench.connectedScope": "已连接当前范围",
  "dataworks.workbench.selectConnection": "请选择连接",
  "dataworks.workbench.status.idle": "空闲",
  "dataworks.workbench.status.loading": "正在运行只读 SQL",
  "dataworks.workbench.status.ready": "就绪",
  "dataworks.workbench.status.error": "查询失败",
  "dataworks.workbench.status.rate_limit": "请求频率受限",
  "dataworks.workbench.workspace": "制品工作区",
  "dataworks.workbench.tab.plan": "计划",
  "dataworks.workbench.tab.sql": "SQL",
  "dataworks.workbench.tab.results": "结果",
  "dataworks.workbench.tab.schema": "结构",
  "dataworks.workbench.sqlScratchpad": "SQL 草稿",
  "dataworks.workbench.untitledQuery": "未命名查询",
  "dataworks.workbench.run": "运行",
  "dataworks.workbench.running": "运行中...",
  "dataworks.workbench.sqlEditor": "SQL 编辑器",
  "dataworks.workbench.emptyResults": "运行只读查询后可在此查看结果。",
  "dataworks.workbench.attachPreview": "将预览附加到智能助手",
  "dataworks.workbench.column": "字段",
  "dataworks.workbench.type": "类型",
  "dataworks.workbench.comment": "注释",
  "dataworks.workbench.schemaLoading": "正在加载表结构...",
  "dataworks.workbench.schemaPartial": "表结构信息不完整。",
  "dataworks.workbench.schemaRateLimit": "表结构请求频率受限。",
  "dataworks.workbench.schemaError": "无法加载表结构。",
  "dataworks.workbench.schemaEmpty": "请选择表以查看结构。",
  "dataworks.workbench.dataResources": "DataWorks 资源",
  "dataworks.workbench.tables": "数据表",
  "dataworks.workbench.tablesLoading": "正在加载数据表...",
  "dataworks.workbench.tablesEmpty": "当前范围没有数据表。",
  "dataworks.workbench.tablesRateLimit": "数据表请求频率受限。",
  "dataworks.workbench.tablesError": "无法加载数据表。",
  "dataworks.workbench.resultsStale": "结果来自较早的 SQL 版本。",
  "dataworks.workbench.rowCount": "{{count}} 行",
  "dataworks.workbench.sqlResults": "SQL 结果",
  "dataworks.workbench.previewTruncated": "预览内容已截断。",
