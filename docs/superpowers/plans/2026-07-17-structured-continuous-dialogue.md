...
> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox syntax for tracking; checked items are complete.
...
- [x] **Step 3: Implement minimal schemas and adapter**
...
- [x] **Step 1: Add failing persistence/restart tests**
...
- [x] **Step 3: Extend state and fix async initialization**
...
- [x] **Step 4: Implement answer reducer**
...
- [x] **Step 1: Add failing API compatibility tests**
...
- [x] **Step 3: Extend request and history models**
...
- [x] **Step 4: Resolve answers before NLU**
...
- [x] **Step 5: Persist readable and structured assistant history**
...
- [x] **Step 6: Return `interaction_expired` safely**
...
- [x] **Step 1: Add failing three-turn table-flow tests**
...
- [x] **Step 2: Run focused flow tests**

Expected: FAIL because clarification data has only `option_chips`.

- [x] **Step 3: Adapt clarification results**
...
- [x] **Step 4: Add selected-table action interaction**
...
- [x] **Step 5: Preserve custom answers and identifiers**
...
- Test: `frontend/src/__tests__/structuredInteraction.spec.ts`
- Test: `frontend/src/__tests__/agentChatCompatibility.spec.ts`
...
- [x] **Step 1: Add failing TypeScript request tests**
...
- [x] **Step 5: Wire SmartChatPage restore/send**
...
- [x] **Step 6: Keep AgentChat compatible**
...
- [x] **Step 4: Harden OpenAPINodeAdapter evidence injection**
...
- [x] **Step 3: Build confirmation interaction**
...
- [x] **Step 4: Execute only confirmed writes**
...
- [x] **Step 6: Optional real test-node verification — intentionally skipped by the write-safety policy**

No real node was created because the user did not authorize a live DataWorks write test. Mocked clients and read-only directory evidence cover create/update/recheck/readback behavior. Never create directories or publish.
...
- [x] **Step 1: Run backend integration suite**
...
- [x] **Step 4: Verify no directory-create behavior**
...
- [x] **Step 5: Update implementation-status documentation**
